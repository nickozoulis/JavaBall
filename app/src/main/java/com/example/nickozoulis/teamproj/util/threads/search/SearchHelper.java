...
public class SearchHelper {
	...
	private SearchHelper(Context coursesFragment) {
		this.context = coursesFragment;
	}
	

	private SearchHelper open() throws SQLException {
	...
	public Cursor searchByInputText(String inputText) throws SQLException {
		// We added inputText.toUpperCase() so user doesnt have to change it
		// manually.
	 ...
	 */
	public static SearchHelper getSearchHelper(Context coursesFragment) {
		if (searchHelper == null) {
			searchHelper = new SearchHelper(coursesFragment);
			searchHelper.open();
		}
		return searchHelper;
	}
	...
	public static void setSearchHelper(SearchHelper searchHelper) {
